...
(function () {
  ...
  function slides(ctx) {
    ...
    list.push({
      title: "路線を追加する",
      body:
        "<p>画面の右側（スマホでは、下のシート）にある<b>サイドバー</b>の「<b>路線を追加</b>」を押すと、新しい路線ができます。</p>" +
    ...
    list.push({
      ...
      body:
        ...
        "<li>点をクリックすると選択（<b>黄色＋赤い縁</b>）。<b>Ctrl+クリック</b>（タッチでは、ツールバーの「複数選択」）で複数選択できます</li>" +
    ...
    list.push({
      title: "点を選んで設定する",
      body:
        "<p>点を<b>クリック</b>すると選ばれ、サイドバー（スマホでは、下のシート）に<b>施設設定</b>欄が開きます（IC・JCTなどを設定できます）。</p>" +
